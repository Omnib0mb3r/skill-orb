...
Generate content for section `section-04-scaffold` (filename: `section-04-scaffold.md`).
...
for `section-04-scaffold` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\03-vscode-extension/sections/section-04-scaffold.md`
