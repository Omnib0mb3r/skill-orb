...
Generate content for section `section-01-api-extensions` (filename: `section-01-api-extensions.md`).
...
for `section-01-api-extensions` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-01-api-extensions.md`
