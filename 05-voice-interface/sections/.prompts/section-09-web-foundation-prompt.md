...
Generate content for section `section-09-web-foundation` (filename: `section-09-web-foundation.md`).
...
for `section-09-web-foundation` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-09-web-foundation.md`
