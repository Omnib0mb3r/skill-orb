...
Generate content for section `section-02-voice-foundation` (filename: `section-02-voice-foundation.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\dev\tools\DevNeural\05-voice-interface/claude-plan.md` - Full implementation plan
2. `C:\dev\tools\DevNeural\05-voice-interface/claude-plan-tdd.md` - Test stubs for each section
3. `C:\dev\tools\DevNeural\05-voice-interface/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-voice-foundation` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-02-voice-foundation.md`
