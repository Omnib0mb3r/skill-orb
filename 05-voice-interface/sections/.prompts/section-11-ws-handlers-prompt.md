...
Generate content for section `section-11-ws-handlers` (filename: `section-11-ws-handlers.md`).
...
for `section-11-ws-handlers` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-11-ws-handlers.md`
