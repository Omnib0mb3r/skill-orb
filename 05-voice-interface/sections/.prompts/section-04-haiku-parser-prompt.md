...
Generate content for section `section-04-haiku-parser` (filename: `section-04-haiku-parser.md`).
...
for `section-04-haiku-parser` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-04-haiku-parser.md`
