...
Generate content for section `section-08-entry-point` (filename: `section-08-entry-point.md`).
...
for `section-08-entry-point` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-08-entry-point.md`
