...
Generate content for section `section-05-parser-pipeline` (filename: `section-05-parser-pipeline.md`).
...
for `section-05-parser-pipeline` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-05-parser-pipeline.md`
