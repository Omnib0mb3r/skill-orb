...
Generate content for section `section-06-routing` (filename: `section-06-routing.md`).
...
for `section-06-routing` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-06-routing.md`
