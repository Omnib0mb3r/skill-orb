...
Generate content for section `section-07-formatter` (filename: `section-07-formatter.md`).
...
for `section-07-formatter` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-07-formatter.md`
