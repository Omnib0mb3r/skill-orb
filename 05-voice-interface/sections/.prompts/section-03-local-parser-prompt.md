...
Generate content for section `section-03-local-parser` (filename: `section-03-local-parser.md`).
...
for `section-03-local-parser` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\05-voice-interface/sections/section-03-local-parser.md`
