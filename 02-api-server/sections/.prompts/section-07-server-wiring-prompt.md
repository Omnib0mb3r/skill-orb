...
Generate content for section `section-07-server-wiring` (filename: `section-07-server-wiring.md`).
...
for `section-07-server-wiring` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\02-api-server/sections/section-07-server-wiring.md`
