...
Generate content for section `section-04-rest-routes` (filename: `section-04-rest-routes.md`).
...
for `section-04-rest-routes` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\02-api-server/sections/section-04-rest-routes.md`
