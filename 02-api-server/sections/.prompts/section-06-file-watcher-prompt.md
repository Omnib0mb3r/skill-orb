...
Generate content for section `section-06-file-watcher` (filename: `section-06-file-watcher.md`).
...
for `section-06-file-watcher` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\02-api-server/sections/section-06-file-watcher.md`
