...
+});
diff --git a/02-api-server/tsconfig.json b/02-api-server/tsconfig.json
new file mode 100644
index 0000000..79e4afb
--- /dev/null
+++ b/02-api-server/tsconfig.json
@@ -0,0 +1,17 @@
+{
+  "compilerOptions": {
+    "target": "ES2022",
...
+}
diff --git a/02-api-server/vitest.config.ts b/02-api-server/vitest.config.ts
new file mode 100644
index 0000000..66be301
--- /dev/null
+++ b/02-api-server/vitest.config.ts
@@ -0,0 +1,9 @@
