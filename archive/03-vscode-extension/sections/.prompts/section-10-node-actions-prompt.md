...
Generate content for section `section-10-node-actions` (filename: `section-10-node-actions.md`).
...
for `section-10-node-actions` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\03-vscode-extension/sections/section-10-node-actions.md`
