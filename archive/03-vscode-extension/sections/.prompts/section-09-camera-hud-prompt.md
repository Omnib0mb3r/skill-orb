...
Generate content for section `section-09-camera-hud` (filename: `section-09-camera-hud.md`).
...
for `section-09-camera-hud` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\03-vscode-extension/sections/section-09-camera-hud.md`
