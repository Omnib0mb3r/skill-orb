...
Generate content for section `section-03-api-server` (filename: `section-03-api-server.md`).
...
for `section-03-api-server` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\03-vscode-extension/sections/section-03-api-server.md`
