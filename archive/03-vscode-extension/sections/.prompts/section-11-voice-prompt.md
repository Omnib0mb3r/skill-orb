...
Generate content for section `section-11-voice` (filename: `section-11-voice.md`).
...
for `section-11-voice` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\03-vscode-extension/sections/section-11-voice.md`
