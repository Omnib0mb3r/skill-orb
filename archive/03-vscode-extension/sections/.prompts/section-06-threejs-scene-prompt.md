...
Generate content for section `section-06-threejs-scene` (filename: `section-06-threejs-scene.md`).
...
for `section-06-threejs-scene` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\03-vscode-extension/sections/section-06-threejs-scene.md`
