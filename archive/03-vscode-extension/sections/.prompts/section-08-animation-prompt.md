...
Generate content for section `section-08-animation` (filename: `section-08-animation.md`).
...
for `section-08-animation` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\03-vscode-extension/sections/section-08-animation.md`
