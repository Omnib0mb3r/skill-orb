...
Generate content for section `section-07-rendering` (filename: `section-07-rendering.md`).
...
for `section-07-rendering` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\03-vscode-extension/sections/section-07-rendering.md`
