...
Generate content for section `section-05-extension-host` (filename: `section-05-extension-host.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\dev\tools\DevNeural\03-vscode-extension/claude-plan.md` - Full implementation plan
2. `C:\dev\tools\DevNeural\03-vscode-extension/claude-plan-tdd.md` - Test stubs for each section
3. `C:\dev\tools\DevNeural\03-vscode-extension/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-05-extension-host` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\03-vscode-extension/sections/section-05-extension-host.md`
