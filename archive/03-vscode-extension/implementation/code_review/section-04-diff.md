diff --git a/03-vscode-extension/.vscodeignore b/03-vscode-extension/.vscodeignore
new file mode 100644
index 0000000..91243ae
--- /dev/null
+++ b/03-vscode-extension/.vscodeignore
@@ -0,0 +1,9 @@
+src/**
+webview/**
+node_modules/**
...
+**/*.map
+**/*.ts
diff --git a/03-vscode-extension/esbuild.mjs b/03-vscode-extension/esbuild.mjs
new file mode 100644
index 0000000..446540d
--- /dev/null
+++ b/03-vscode-extension/esbuild.mjs
@@ -0,0 +1,29 @@
...
+  }
+}
diff --git a/03-vscode-extension/tests/manifest.test.ts b/03-vscode-extension/tests/manifest.test.ts
new file mode 100644
index 0000000..fa1c249
--- /dev/null
+++ b/03-vscode-extension/tests/manifest.test.ts
@@ -0,0 +1,51 @@
...
+}
diff --git a/03-vscode-extension/webview/animation.ts b/03-vscode-extension/webview/animation.ts
new file mode 100644
index 0000000..8669369
--- /dev/null
+++ b/03-vscode-extension/webview/animation.ts
@@ -0,0 +1,2 @@
+// Implemented in section-08-animation
+export {};
diff --git a/03-vscode-extension/webview/camera.ts b/03-vscode-extension/webview/camera.ts
new file mode 100644
index 0000000..6a058b0
--- /dev/null
+++ b/03-vscode-extension/webview/camera.ts
@@ -0,0 +1,2 @@
...
new file mode 100644
index 0000000..9809c11
--- /dev/null
+++ b/03-vscode-extension/webview/edges.ts
@@ -0,0 +1,2 @@
+// Implemented in section-07-rendering
+export {};
diff --git a/03-vscode-extension/webview/hud.ts b/03-vscode-extension/webview/hud.ts
new file mode 100644
index 0000000..6a058b0
--- /dev/null
+++ b/03-vscode-extension/webview/hud.ts
@@ -0,0 +1,2 @@
+// Implemented in section-09-camera-hud
+export {};
...
+// Implemented in section-06-threejs-scene
+export {};
diff --git a/03-vscode-extension/webview/search.ts b/03-vscode-extension/webview/search.ts
new file mode 100644
index 0000000..6a058b0
--- /dev/null
+++ b/03-vscode-extension/webview/search.ts
@@ -0,0 +1,2 @@
+// Implemented in section-09-camera-hud
+export {};
diff --git a/03-vscode-extension/webview/voice.ts b/03-vscode-extension/webview/voice.ts
new file mode 100644
index 0000000..4f1b2ea
--- /dev/null
+++ b/03-vscode-extension/webview/voice.ts
@@ -0,0 +1,2 @@
+// Implemented in section-11-voice
+export {};
