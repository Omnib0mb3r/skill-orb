...
Generate content for section `section-04-formatter` (filename: `section-04-formatter.md`).
...
for `section-04-formatter` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\04-session-intelligence/sections/section-04-formatter.md`
