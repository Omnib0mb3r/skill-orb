...
Generate content for section `section-05-entry-point` (filename: `section-05-entry-point.md`).
...
for `section-05-entry-point` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\04-session-intelligence/sections/section-05-entry-point.md`
