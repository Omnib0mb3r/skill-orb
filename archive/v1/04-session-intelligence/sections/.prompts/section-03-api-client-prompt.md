...
Generate content for section `section-03-api-client` (filename: `section-03-api-client.md`).
...
for `section-03-api-client` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\04-session-intelligence/sections/section-03-api-client.md`
