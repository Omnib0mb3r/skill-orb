...
Generate content for section `section-06-install-script` (filename: `section-06-install-script.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\dev\tools\DevNeural\04-session-intelligence/claude-plan.md` - Full implementation plan
2. `C:\dev\tools\DevNeural\04-session-intelligence/claude-plan-tdd.md` - Test stubs for each section
3. `C:\dev\tools\DevNeural\04-session-intelligence/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-install-script` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\04-session-intelligence/sections/section-06-install-script.md`
