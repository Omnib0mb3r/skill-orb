...
Generate content for section `section-02-graph-types` (filename: `section-02-graph-types.md`).
...
for `section-02-graph-types` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\02-api-server/sections/section-02-graph-types.md`
