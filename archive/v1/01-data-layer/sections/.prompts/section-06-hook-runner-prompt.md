...
Generate content for section `section-06-hook-runner` (filename: `section-06-hook-runner.md`).
...
for `section-06-hook-runner` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\01-data-layer/sections/section-06-hook-runner.md`
