...
Generate content for section `section-03-identity` (filename: `section-03-identity.md`).
...
for `section-03-identity` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\01-data-layer/sections/section-03-identity.md`
