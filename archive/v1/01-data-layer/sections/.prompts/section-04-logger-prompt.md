...
Generate content for section `section-04-logger` (filename: `section-04-logger.md`).
...
for `section-04-logger` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\01-data-layer/sections/section-04-logger.md`
