...
Generate content for section `section-08-cli-integration` (filename: `section-08-cli-integration.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\dev\tools\DevNeural\06-notebooklm-integration/claude-plan.md` - Full implementation plan
2. `C:\dev\tools\DevNeural\06-notebooklm-integration/claude-plan-tdd.md` - Test stubs for each section
3. `C:\dev\tools\DevNeural\06-notebooklm-integration/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-08-cli-integration` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\06-notebooklm-integration/sections/section-08-cli-integration.md`
