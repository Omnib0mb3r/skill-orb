...
Generate content for section `section-03-log-reader` (filename: `section-03-log-reader.md`).
...
for `section-03-log-reader` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\06-notebooklm-integration/sections/section-03-log-reader.md`
