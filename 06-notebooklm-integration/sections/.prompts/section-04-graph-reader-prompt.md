...
Generate content for section `section-04-graph-reader` (filename: `section-04-graph-reader.md`).
...
for `section-04-graph-reader` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\06-notebooklm-integration/sections/section-04-graph-reader.md`
