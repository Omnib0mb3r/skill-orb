...
Generate content for section `section-07-writer` (filename: `section-07-writer.md`).
...
for `section-07-writer` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\06-notebooklm-integration/sections/section-07-writer.md`
