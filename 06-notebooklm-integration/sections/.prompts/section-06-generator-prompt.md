...
Generate content for section `section-06-generator` (filename: `section-06-generator.md`).
...
for `section-06-generator` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\06-notebooklm-integration/sections/section-06-generator.md`
