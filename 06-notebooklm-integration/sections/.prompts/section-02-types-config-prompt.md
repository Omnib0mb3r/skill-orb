...
Generate content for section `section-02-types-config` (filename: `section-02-types-config.md`).
...
for `section-02-types-config` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\06-notebooklm-integration/sections/section-02-types-config.md`
