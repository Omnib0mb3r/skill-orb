...
Generate content for section `section-02-identity` (filename: `section-02-identity.md`).
...
for `section-02-identity` to understand what this section should contain.
...
`C:\dev\tools\DevNeural\04-session-intelligence/sections/section-02-identity.md`
